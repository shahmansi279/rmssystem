...
public class PaymentManager {
	...
	public void processTripPayment(Trip trip){
		...
		invokePaymentContext(paymentMethod,this.trip);
	...
	private void invokePaymentContext(String paymentMethod, Trip trip) {

		//Invoking payment context to process payment based on strategy determined
		...
		ctx.performProcessPayment(this.trip.getTripFare());
