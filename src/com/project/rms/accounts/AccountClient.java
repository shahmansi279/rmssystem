...
public class AccountClient {
	...
	// public static List<Customer> members1 = new ArrayList<Customer>();
	public static void main(String[] args) {
		...
		// Member smem1;
		Customer smem1;
		member = new Customer("1", "Thiagu", "Natar", null, null, null, null, null, null, null, null, null, null, null,
				"GUEST");
		// mops.addMembers(member);
		// Initialize member array
		smem1 = new Customer("10", "Abhishek", "Cust10Lname", "Cust10@yahoo.com", "4085550010", "Cust10 Address1",
				"Cust10 Address2", "Cust10 City", "Cust10 State", "90010", "Email", "Cash", "1234567890120010", "N",
				"GUEST");
		members1.add(smem1);
		smem1 = new Customer("1", "Parth", "Cust1Lname", "Cust01@yahoo.com", "4085550001", "Cust1 Address1",
		...
		// TBD
		// smem2 = new ServiceProvider(" ");

		smem1 = new Customer("2", "Cust2Fname", "Cust2Lname", "Cust02@yahoo.com", "4085550002", "Cust2 Address1",
				"Cust2 Address2", "Cust2 City", "Cust2 State", "90002", "Email", "CreditCard", "1234567890120002", "Y",
				"GUEST");
		members1.add(smem1);
		// mops.addMembers(smem1);

		smem1 = new Customer("3", "Cust3Fname", "Cust3Lname", "Cust03@yahoo.com", "4085550003", "Cust3 Address1",
				"Cust3 Address2", "Cust3 City", "Cust3 State", "90003", "SMS", "Cash", "1234567890120003", "Y", "PREMIER");
		members1.add(smem1);
		smem1 = new Customer("4", "Zebra", "Cust4Lname", "Cust04@yahoo.com", "4085550004", "Cust4 Address1",
				"Cust4 Address2", "Cust4 City", "Cust4 State", "90004", "Email", "Cash", "1234567890120004", "Y", "PREMIER");
		members1.add(smem1);
		smem1 = new Customer("5", "Cust5Fname", "Cust5Lname", "Cust05@yahoo.com", "4085550005", "Cust5 Address1",
				"Cust5 Address2", "Cust5 City", "Cust5 State", "90005", "Email", "Cash", "1234567890120005", "Y", "PREMIER");
		members1.add(smem1);
		smem1 = new Customer("6", "Cust6Fname", "Cust6Lname", "Cust06@yahoo.com", "4085550006", "Cust6 Address1",
				"Cust6 Address2", "Cust6 City", "Cust6 State", "90006", "Email", "Cash", "1234567890120006", "N", "GUEST");
		members1.add(smem1);
		smem1 = new Customer("7", "Cust7Fname", "Cust7Lname", "Cust07@yahoo.com", "4085550007", "Cust7 Address1",
				"Cust7 Address2", "Cust7 City", "Cust7 State", "90007", "Email", "Cash", "1234567890120007", "Y", "PREMIER");
		members1.add(smem1);
		smem1 = new Customer("8", "Cust8Fname", "Cust8Lname", "Cust08@yahoo.com", "4085550008", "Cust8 Address1",
				"Cust8 Address2", "Cust8 City", "Cust8 State", "90008", "Email", "Cash", "1234567890120008", "Y", "PREMIER");
		members1.add(smem1);
		smem1 = new Customer("9", "Cust9Fname", "Cust9Lname", "Cust09@yahoo.com", "4085550009", "Cust9 Address1",
				"Cust9 Address2", "Cust9 City", "Cust9 State", "90009", "Email", "Cash", "1234567890120009", "Y", "PREMIER");
		members1.add(smem1);
